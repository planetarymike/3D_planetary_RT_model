...
NDBGFLAGS=-O0 -g -G 
#                                 ^^ suppress warnings generated by Eigen library
...
generate_source_function_debug_warn:
	$(CC) generate_source_function.cpp $(SRCFILES) $(IDIR) $(LIBS) -O0 -g -Wall -Wextra -Wno-deprecated-copy -o generate_source_function.x
#                                                                                           ^^ suppress warnings generated by Eigen library
