//H_lyman_multiplet.hpp --- simulate the full Lyman alpha and beta
//multiplet system, including the fine structure doublet for each
//emission
...
struct H_lyman_multiplet : multiplet_CFR_emission<N_VOXELS,
						  /*emission_type = */ H_lyman_multiplet<N_VOXELS>,
						  /*los_tracker_type = */ H_lyman_multiplet_tracker> {
protected:
  typedef multiplet_CFR_emission<N_VOXELS,
				 /*emission_type = */ H_lyman_multiplet<N_VOXELS>,
				 /*los_tracker_type = */ H_lyman_multiplet_tracker> parent;
  friend parent;
...
public:
  ...
  using los = H_lyman_multiplet_tracker<influence, N_VOXELS>;
...
public:
  ...
  void compute_single_scattering(const int &start_voxel, influence_tracker &tracker, bool sun_visible = true) {
	...
	tracker.holstein_T_final[i_line]   = 0.0;
      ...
      Real solar_brightness_Hz = i_line < 2 ? solar_brightness_lya_Hz : solar_brightness_lyb_Hz;
